...
export function ThreeHeroScene() {
  ...
  useEffect(() => {
    ...
    ctx.beginPath(); ctx.arc(140, 180, 90, 0, Math.PI * 2); ctx.fill()
    ctx.fillStyle = 'rgba(30,50,90,0.55)'
    ctx.beginPath(); ctx.arc(380, 340, 110, 0, Math.PI * 2); ctx.fill()
    ctx.fillStyle = 'rgba(20,20,20,0.35)'
    ctx.beginPath(); ctx.arc(300, 90, 60, 0, Math.PI * 2); ctx.fill()
