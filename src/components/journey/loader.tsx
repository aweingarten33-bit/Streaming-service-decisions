      ...
      {open && (
        ...
        >
          ...
          <div className="relative flex flex-col items-center gap-6">
            <svg width="120" height="120" viewBox="0 0 120 120" className="drop-shadow-[0_0_18px_rgba(127,232,255,0.35)]">
              ...
              <text x="60" y="66" textAnchor="middle" fill="#ffffff" fontSize="16" fontFamily="ui-monospace,monospace" letterSpacing="2">
